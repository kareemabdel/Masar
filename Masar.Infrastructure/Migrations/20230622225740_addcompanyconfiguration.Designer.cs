...
namespace Masar.Infrastructure.Migrations
{
    ...
    [Migration("20230622225740_addcompanyconfiguration")]
            ...
            modelBuilder.Entity("Masar.Domain.Entities.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreationDate = new DateTimeOffset(new DateTime(2023, 6, 23, 1, 57, 40, 143, DateTimeKind.Unspecified).AddTicks(7941), new TimeSpan(0, 3, 0, 0, 0)),
            ...
            modelBuilder.Entity("Masar.Domain.Entities.ApplicationUserRoles", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            RoleId = 1,
                            CreationDate = new DateTimeOffset(new DateTime(2023, 6, 23, 1, 57, 40, 143, DateTimeKind.Unspecified).AddTicks(8028), new TimeSpan(0, 3, 0, 0, 0)),
                            IsActive = true,
                            IsDeleted = false
                        });
                });
            ...
            modelBuilder.Entity("Masar.Domain.Entities.Cities", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Code = "01",
                            CreationDate = new DateTimeOffset(new DateTime(2023, 6, 23, 1, 57, 40, 143, DateTimeKind.Unspecified).AddTicks(7654), new TimeSpan(0, 3, 0, 0, 0)),
                        ...
                        new
                        {
                            ...
                            Code = "02",
                            CreationDate = new DateTimeOffset(new DateTime(2023, 6, 23, 1, 57, 40, 143, DateTimeKind.Unspecified).AddTicks(7777), new TimeSpan(0, 3, 0, 0, 0)),
                        ...
                        new
                        {
                            ...
                            Code = "03",
                            CreationDate = new DateTimeOffset(new DateTime(2023, 6, 23, 1, 57, 40, 143, DateTimeKind.Unspecified).AddTicks(7783), new TimeSpan(0, 3, 0, 0, 0)),
                        ...
                        new
                        {
                            ...
                            Code = "04",
                            CreationDate = new DateTimeOffset(new DateTime(2023, 6, 23, 1, 57, 40, 143, DateTimeKind.Unspecified).AddTicks(7786), new TimeSpan(0, 3, 0, 0, 0)),
                        ...
                        new
                        {
                            ...
                            Code = "05",
                            CreationDate = new DateTimeOffset(new DateTime(2023, 6, 23, 1, 57, 40, 143, DateTimeKind.Unspecified).AddTicks(7790), new TimeSpan(0, 3, 0, 0, 0)),
            ...
            modelBuilder.Entity("Masar.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreationDate = new DateTimeOffset(new DateTime(2023, 6, 23, 1, 57, 40, 143, DateTimeKind.Unspecified).AddTicks(7974), new TimeSpan(0, 3, 0, 0, 0)),
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Admin",
                            NameAr = "مدير"
                        ...
                        {
                            Id = 2,
                            CreationDate = new DateTimeOffset(new DateTime(2023, 6, 23, 1, 57, 40, 143, DateTimeKind.Unspecified).AddTicks(8004), new TimeSpan(0, 3, 0, 0, 0)),
                            IsActive = true,
                            IsDeleted = false,
                            Name = "User",
                            NameAr = "مستخدم"
